...
import { createSalesRep, apiErrorMessage } from '@/lib/api';
...
export default function NewRepPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      // El vendedor cuelga del admin que lo crea (el backend lo resuelve con el JWT).
  ...
  return (
    <div className="max-w-lg">
      ...
      <p className="text-sm text-zinc-600 mb-6">
        El vendedor quedará en tu equipo. Recibirá una contraseña temporal para su primer ingreso.
      </p>
